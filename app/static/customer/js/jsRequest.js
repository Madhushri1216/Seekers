  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (var i = 0; i < response.length; i++) {
        var j = i + 1;
        if(response[i].cr_status == "Accepted" && response[i].cr_payment_status == "Success") {
        $("#tableData").append('<tr><td>' + j + '</td><td style="display: none;">' + response[i].cr_id + '</td><td>' + response[i].cr_seat_type + '</td><td>' + response[i].cr_department + '</td><td>' + response[i].cr_name + '</td><td>' + response[i].cr_email + '</td><td>' + response[i].cr_mobile + '</td><td>' + response[i].cr_address + '</td><td>' + response[i].cr_percentage + '</td><td>' + response[i].cr_previous_education + '</td><td>' + response[i].cr_year_passing + '</td><td>' + response[i].cr_status + '</td><td>' + response[i].cr_payment_status + '</td><td>' + response[i].cr_amount );
      }else if(response[i].cr_status == "Rejected") {
        $("#tableData").append('<tr><td>' + j + '</td><td style="display: none;">' + response[i].cr_id + '</td><td>' + response[i].cr_seat_type + '</td><td>' + response[i].cr_department + '</td><td>' + response[i].cr_name + '</td><td>' + response[i].cr_email + '</td><td>' + response[i].cr_mobile + '</td><td>' + response[i].cr_address + '</td><td>' + response[i].cr_percentage + '</td><td>' + response[i].cr_previous_education + '</td><td>' + response[i].cr_year_passing + '</td><td>' + response[i].cr_status + '</td><td>' + response[i].cr_payment_status + '</td><td>' + response[i].cr_amount + '</td><td><a href="javascript:void(0);" title="Delete" data-bs-toggle="modal" data-bs-target="#delete_modal" class="text-danger" id="delete_row" onClick="getRowsDelete();">Process</a></div></td></tr>');
     } 
     else {
       $("#tableData").append('<tr><td>' + j + '</td><td style="display: none;">' + response[i].cr_id + '</td><td>' + response[i].cr_seat_type + '</td><td>' + response[i].cr_department + '</td><td>' + response[i].cr_name + '</td><td>' + response[i].cr_email + '</td><td>' + response[i].cr_mobile + '</td><td>' + response[i].cr_address + '</td><td>' + response[i].cr_percentage + '</td><td>' + response[i].cr_previous_education + '</td><td>' + response[i].cr_year_passing + '</td><td>' + response[i].cr_status + '</td><td>' + response[i].cr_payment_status + '</td><td>' + response[i].cr_amount + '</td><td><a href="javascript:void(0);" title="Delete" data-bs-toggle="modal" data-bs-target="#delete_modal" class="text-danger" id="delete_row" onClick="getRowsDelete();">Process</a></div></td></tr>');
     }
